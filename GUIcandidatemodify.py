...
#    Feb 25, 2022 07:16:51 PM +07  platform: Windows NT
...
class Toplevel1:
    def __init__(self, top=None):
        ...
        top.geometry("1200x610+35+1")
        top.minsize(120, 1)
        top.maxsize(1200, 768)
        top.resizable(1,  1)
        top.title("Cow-Buffalo Borrowing Program")
        ...
        self.Button_cowtransaction.configure(background="#80ff80")
        ...
        self.Button_canculatecharge.place(relx=0.253, rely=0.667, height=44
                , width=97)
        ...
        self.Button_canculatecharge.configure(background="#d9d9d9")
        ...
        self.Button3_1_1 = tk.Button(self.Frame2)
        self.Button3_1_1.place(relx=0.658, rely=0.667, height=44, width=97)
        self.Button3_1_1.configure(activebackground="#ececec")
        self.Button3_1_1.configure(activeforeground="#000000")
        self.Button3_1_1.configure(background="#d9d9d9")
        self.Button3_1_1.configure(compound='left')
        self.Button3_1_1.configure(disabledforeground="#a3a3a3")
        self.Button3_1_1.configure(font="-family {AngsanaUPC} -size 15 -weight bold")
        self.Button3_1_1.configure(foreground="#000000")
        self.Button3_1_1.configure(highlightbackground="#d9d9d9")
        self.Button3_1_1.configure(highlightcolor="black")
        self.Button3_1_1.configure(pady="0")
        self.Button3_1_1.configure(text='''บันทึกสถานะ''')

        self.Check_overstatus = tk.Checkbutton(self.Frame2)
        self.Check_overstatus.place(relx=0.354, rely=0.727, relheight=0.152
                , relwidth=0.072)
        self.Check_overstatus.configure(activebackground="#ececec")
        self.Check_overstatus.configure(activeforeground="#000000")
        self.Check_overstatus.configure(anchor='w')
        self.Check_overstatus.configure(background="#d9d9d9")
        self.Check_overstatus.configure(compound='left')
        self.Check_overstatus.configure(disabledforeground="#a3a3a3")
        self.Check_overstatus.configure(font="-family {AngsanaUPC} -size 18 -weight bold")
        self.Check_overstatus.configure(foreground="#000000")
        self.Check_overstatus.configure(highlightbackground="#d9d9d9")
        self.Check_overstatus.configure(highlightcolor="black")
        self.Check_overstatus.configure(justify='left')
        self.Check_overstatus.configure(text='''ส่งช้า''')
        self.Check_overstatus.configure(variable=self.che72)
        ...
        self.Label_search.configure(background="#978df1")
        ...
        self.Button_search.configure(background="#80ff80")
        ...
        self.Label_transactionitem.configure(background="#978df1")
