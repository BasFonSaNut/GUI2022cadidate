...
import GUIcandidatemodify_support
...
class Toplevel1:
    def __init__(self, top=None):
        ...
        self.Button_cowtransaction.configure(command=GUIcandidatemodify_support.makeCowtransaction)
        ...
        self.Button_bufftransaction.configure(command=GUIcandidatemodify_support.makeBuffalotran)
        ...
        self.Button_createDb.configure(command=GUIcandidatemodify_support.createDb)
        ...
        self.Button_exit.configure(command=GUIcandidatemodify_support.exitProgram)
        ...
        self.Button_save.configure(command=GUIcandidatemodify_support.doTransaction)
        ...
        self.Button_calculatepayment.configure(command=GUIcandidatemodify_support.doCancelreturn)
        ...
        self.Button_updatestatus.configure(command=GUIcandidatemodify_support.doReturn)
        ...
        self.Button_delete.configure(command=GUIcandidatemodify_support.deleteTransaction)
        ...
        self.Button_search.configure(command=GUIcandidatemodify_support.searchTransaction)
        ...
        self.Button_export.configure(command=GUIcandidatemodify_support.export)
        ...
        self.Button_Edit.configure(command=GUIcandidatemodify_support.Button_EditClick)
...
def _on_shiftmouse(event, widget):
    if platform.system() == 'Windows':
        ...
        if event.num == 4:
            ...
            widget.xview_scroll(1, 'units')
def start_up():
    GUIcandidatemodify_support.main()
